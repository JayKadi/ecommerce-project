...
# Load .env only if python-dotenv is available (localhost)
try:
    from dotenv import load_dotenv
    load_dotenv(os.path.join(BASE_DIR, '.env'))
except ImportError:
    pass  # On Railway, dotenv not installed - that's OK!
...
# Add this to help collectstatic find Django's admin files
import django
STATICFILES_DIRS = []

# Tell Django where to find static files (especially admin files)
STATICFILES_FINDERS = [
